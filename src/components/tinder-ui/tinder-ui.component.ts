...
import { IJobPostCard } from "../../model/interfaces";
...
export class TinderUiComponent implements OnChanges, AfterViewInit {
  ...
  @Input("cards") cards: Array<IJobPostCard> = [];

  originalCards: Array<IJobPostCard> = [];
  currentPosition = 0;
  ...
  @Output() likeEvent = new EventEmitter<IJobPostCard>();
  @Output() dislikeEvent = new EventEmitter<IJobPostCard>();
  @Output() passEvent = new EventEmitter<IJobPostCard>();
  @Output() moreInfoEvent = new EventEmitter<IJobPostCard>();
